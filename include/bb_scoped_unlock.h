...
namespace bytebinder {
     ...
     * @code
     * {
     *     bb::scoped_unlock unlock(target_address, region_size);
     *     std::memcpy(reinterpret_cast<void*>(target_address), buffer, region_size);
     * } // protection restored here
     * @endcode
     *
     * @note On Windows the original protection is captured as a DWORD; on POSIX
     *       targets it is captured as the int returned by mprotect-style flags.
     */
